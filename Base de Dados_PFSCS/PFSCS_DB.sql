...
/******************************* Inserts [dbo].[Cliente] *******************************/
GO
INSERT [dbo].[Cliente] ([ClienteID], [DataNascimento], [Pais], [Localizacao], [EntidadeID]) VALUES (1, CAST(N'14-04-1993' AS DATE), Portugal, N'Rua 24 junho, 4800-010', 1)
...
GO
INSERT [dbo].[Medalhas] ([MedalhaID], [NomeMedalha], [Descricao], [DataDesbloqueio], [Icon]) VALUES (1, N'10 encomendas atingidas', N'Possui esta medalhas quando atingir 10 encomendas realizadas', CAST(N'15-03-2022' AS DATE), N'icon10.jpeg')
...
GO
INSERT [dbo].[Categoria] ([CategoriaID], [NomeCategoria]) VALUES (1, Pastelaria)


/******************************* Inserts [dbo].[Loja] *******************************/
GO
INSERT [dbo].[Loja] ([LojaID], [Morada], [NIF], [AdminLojaID], [CategoriaID]) VALUES (1, N'Rua Aleixo Ferreira, 4705-022', 55739022203, 1, 1)
...
GO
INSERT [dbo].[CategoriaProduto] ([CategoriaID], [NomeCatProd]) VALUES (1, N'Bebidas')
...
GO
INSERT [dbo].[Estafeta] ([EntidadeID], [Estado], [VeiculoID], [EntidadeID]) VALUES (1, N'Disponível', 1, 3)
...
GO
INSERT [dbo].[Encomenda] ([EncomendaID], [NumEncomenda], [DataEncomenda], [Estado], [ValorTotal], [LojaID], [ClienteID], [EstafetaID]) VALUES (1, 1, CAST(N'17-03-2022' AS DATE), N'Em processamento', CAST(3.50 AS DECIMAL(3, 2), 1, 1, 1)
